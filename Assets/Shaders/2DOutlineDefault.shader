...
Shader "Metkis/2DSprite Outline Default" 
{
	Properties
	{
		...
		_OutlineOffSet2("Outline OffSet 2", Range(0,4)) = 1
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 SampleSpriteTexture (float2 uv)
			{
			   ...
			   fixed4 TempColor2 = tex2D(_MainTex, uv + float2(-_MainTex_TexelSize.x * _OutlineOffSet2, 0.0)) + tex2D(_MainTex, uv - float2(-_MainTex_TexelSize.x * _OutlineOffSet2, 0.0));
			   TempColor2 = TempColor2 + tex2D(_MainTex, uv + float2(0.0, -_MainTex_TexelSize.y * _OutlineOffSet2)) + tex2D(_MainTex, uv - float2(0.0, -_MainTex_TexelSize.y * _OutlineOffSet2));
			   if (TempColor2.a >= 0.01) {
				   TempColor2.a = _Color.a;
			   }


               fixed4 AlphaColor = fixed4(TempColor.a,TempColor.a,TempColor.a,TempColor.a);
			   fixed4 AlphaColor2 = fixed4(TempColor2.a, TempColor2.a, TempColor2.a, TempColor2.a);
               
               fixed4 mainColor = AlphaColor  * AlphaColor2 * _Color.rgba;
